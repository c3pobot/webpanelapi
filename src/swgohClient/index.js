...
const OAUTH_GAME_CLIENT_URL = process.env.OAUTH_GAME_CLIENT_URL || process.env.GAME_CLIENT_URL
const reAuthCodes = {
  4: 'SESSIONEXPIRED',
  5: 'AUTHFAILED',
  11: 'UNAUTHORIZED',
...
module.exports = async(uri, payload = {}, identity = null)=>{
  try{
    ...
    let res = await requestWithRetry(`${OAUTH_GAME_CLIENT_URL}/${uri}`, opts)
